...
function _Radius ({options, ...props}) {
    ...
    const disable = React.useCallback((e) => {
        (e && e.layer) 
            && (radiusMeasurements.addLayer(e.layer),
    ...
    return <Button disabled {..._props}
        ...
        onClick={() => enable() } >
            ...
            <span style={{display: 'block', marginTop: '2px'}}>{getProcessTitle(_id)}</span>
    </Button>
}
...
export const Radius = connect(({app}) => { 
