...
/**
 * @interface IRender
 * `#revise_me`, this name is stupid
 */
export const IRender = Interface.define(
    (function () {
        return {
            /**
             * Access object, any object, specified by `path`.
             * 
             * &nbsp;
             * 
            ...
            /**
             * Execute function specified by `path` with the provided arguments `args`
